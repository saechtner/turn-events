...
urlpatterns = patterns('',
    ...
    url(r'^tournaments/(?P<slug>[-\w\d]*)-(?P<id>\d+)/solo_data\.txt$', tournaments.create_solo_data_txt, name='tournaments.create_solo_data_txt'),
    url(r'^tournaments/(?P<slug>[-\w\d]*)-(?P<id>\d+)/team_data\.txt$', tournaments.create_team_data_txt, name='tournaments.create_team_data_txt'),
