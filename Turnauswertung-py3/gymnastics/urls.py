...
urlpatterns = patterns('',
    ...
    url(r'^athletes/(?P<id>\d+)-(?P<slug>[-\w\d]*)$', athletes.detail, name='athletes.detail'),
    url(r'^athletes/(?P<pk>\d+)-(?P<slug>[-\w\d]*)/edit$', athletes.AthleteUpdateView.as_view(), name='athletes.edit'),
    url(r'^athletes/(?P<pk>\d+)-(?P<slug>[-\w\d]*)/delete$', athletes.AthleteDeleteView.as_view(), name='athletes.delete'),
    ...
    url(r'^streams/(?P<id>\d+)-(?P<slug>[-\w\d]*)$', streams.detail, name='streams.detail'),
    url(r'^streams/(?P<id>\d+)-(?P<slug>[-\w\d]*)/edit$', streams.edit, name='streams.edit'),
    url(r'^streams/(?P<pk>\d+)-(?P<slug>[-\w\d]*)/delete$', streams.StreamDeleteView.as_view(), name='streams.delete'),
