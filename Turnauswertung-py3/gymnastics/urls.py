...
urlpatterns = patterns('',
    ...
    url(r'^athletes/(?P<id>\d+)-(?P<slug>[a-zA-Z\-]*)$', athletes.detail, name='athletes.detail'),
    url(r'^athletes/(?P<pk>\d+)-(?P<slug>[a-zA-Z\-]*)/edit$', athletes.AthleteUpdateView.as_view(), name='athletes.edit'),
    url(r'^athletes/(?P<pk>\d+)-(?P<slug>[a-zA-Z\-]*)/delete$', athletes.AthleteDeleteView.as_view(), name='athletes.delete'),
